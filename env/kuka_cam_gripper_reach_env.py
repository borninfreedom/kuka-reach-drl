...
class KukaCamGripperReachEnv(gym.Env):
    metadata = {
    ...
    def __init__(self, is_render=False, is_good_view=False):
        ...
        # Change the light position to avoid the shadow affects the picture to the model    
...
if __name__ == '__main__':
    ...
    env = KukaCamGripperReachEnv(is_good_view=True,is_render=True)
