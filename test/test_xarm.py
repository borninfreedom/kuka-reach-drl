...
ur3_uid = p.loadURDF("../models/ur3/ur3_with_gripper.urdf",useFixedBase=True)
# ur3_uid=p.loadURDF("franka_panda/panda.urdf",useFixedBase=True)

print('type id={}'.format(type(ur3_uid)))
print('uid={}'.format(ur3_uid))
