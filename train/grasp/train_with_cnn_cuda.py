...
from env.kuka_cam_gripper_reach_env import KukaCamGripperReachEnv, CustomSkipFrame
from ppo.ppo_cnn_cuda import ppo
from spinup.utils.mpi_tools import mpi_fork
import ppo.core_cnn_cuda as core
...
parser.add_argument('--good-view', action="store_true")
...
env = KukaCamGripperReachEnv(is_render=args.render,
                             is_good_view=args.good_view)
